...
import com.example.GreenHome.AllAdapter.DoneAdapter;
...
public class Gone extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_gone, container, false);
        findID(view);
        return view;
    }
    ...
    private void findID(View view) {
        mlist = new ArrayList<>();
        rcl_deal = view.findViewById(R.id.rcl_deal_gone);
        empty = view.findViewById(R.id.gone_empty_img);
        wait_content = view.findViewById(R.id.gone_content);
        ...
        reff.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds : snapshot.getChildren()) {
                    ...
                    if (modelBookingDeal.getGuestID().equals(FirebaseAuth.getInstance().getCurrentUser().getUid()) && modelBookingDeal.getStatus().equals("done")) {
                        mlist.add(modelBookingDeal);
                        adapter = new DoneAdapter(getActivity(), mlist);
